...
<div class="container flex justify-center mb-3">
    <div class="max-w-md w-full bg-gray-600 p-4 rounded-lg shadow-lg">
        ...
        <form action="{{ route('users.mystore') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <label for="cotnent" class="block w-full py-2 px-3 text-white">Content</label>
            <div id="editor" class=" text-white">
