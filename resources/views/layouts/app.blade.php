        ...
        <nav class="bg-gray-800 text-white">
            <div class="container mx-auto flex justify-between items-center py-4 px-6">
                ...
                <ul class="hidden md:flex items-center space-x-6">
                  ...
                  <li><a href="{{route('note.index')}}" class="hover:text-blue-300">Notes</a></li>
                  <li><a href="{{route('shared-notes.index')}}" class="hover:text-blue-300">Shared Notes</a></li>
                  <li><a href="{{route('users.index')}}" class="hover:text-blue-300">Users</a></li>
                  <li>
            ...
            >
                <ul>
                    ...
                    <li><a href="{{route('note.index')}}" class="block hover:text-blue-300">Notes</a></li>
                    <li><a href="{{route('shared-notes.index')}}" class="block hover:text-blue-300">Shared Notes</a></li>
                    <li><a href="{{route('users.index')}}" class="block hover:text-blue-300">Users</a></li>
                </ul>
                <!-- Logout Button -->
